...
void teste_funcao_hash_B()
{
    ...
    // Inserindo funcionários no vetor usando a função hash A
    short int resultado1 = inserir_funcionario_hash_B(vetor, TAMANHO_VETOR_1, funcionario1);
    short int resultado2 = inserir_funcionario_hash_B(vetor, TAMANHO_VETOR_1, funcionario2);
    short int resultado3 = inserir_funcionario_hash_B(vetor, TAMANHO_VETOR_1, funcionario3);
    short int resultado4 = inserir_funcionario_hash_B(vetor, TAMANHO_VETOR_1, funcionario4);
    short int resultado5 = inserir_funcionario_hash_B(vetor, TAMANHO_VETOR_1, funcionario5);
